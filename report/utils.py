english_stop_words = {
    ...
    "appear", "appreciate", "appropriate", "are", "aren't", "around", "as", "aside", "ask",
    ...
    "by", "c'mon", "c's", "came", "can", "can't", "cannot", "cant", "cause", "causes", "certain",
    ...
    "couldn't", "course", "currently", "definitely", "described", "despite", "did", "didn't",
    ...
    "up", "upon", "us", "use", "used", "useful", "uses", "using", "usually", "value", "various",
